...
export default function CollectionInfoPanel({ collection }: CollectionInfoPanelProps) {
  ...
  return (
    <div className="border-b text-foreground">
        ...
        <div className="flex gap-2">
          ...
          <div className="flex flex-col gap-1 min-w-0 overflow-hidden">
            ...
            <div className="flex items-center gap-2">
              ...
              <Star className="w-3 h-3 text-os-gray-300 shrink-0" />
      ...
      {/* Mobile Info Section */}
      {showInfo && (
        <div className="md:hidden p-3 border-t border-border-subtle">
          {/* Stats */}
          <div className="grid grid-cols-2 gap-2 mb-3">
            <div>
              <div className="text-os-gray-300 text-xs mb-0.5">Floor Price</div>
              <div className="font-medium font-sans text-xs sm:text-sm">
                4.708 <span className="text-os-gray-300">SOL</span>
              </div>
            </div>
            <div>
              <div className="text-os-gray-300 text-xs mb-0.5">24h Vol</div>
              <div className="font-medium font-sans text-xs sm:text-sm">
                137.635 <span className="text-os-gray-300">SOL</span>
              </div>
            </div>
            <div>
              <div className="text-os-gray-300 text-xs mb-0.5">Owners</div>
              <div className="font-medium font-sans text-xs sm:text-sm">
                327 <span className="text-os-gray-300">32.7%</span>
              </div>
            </div>
            <div>
              <div className="text-os-gray-300 text-xs mb-0.5">Market Cap</div>
              <div className="font-medium font-sans text-xs sm:text-sm">$867.1K</div>
            </div>
          </div>
      ...
      <div className="hidden md:block mb-2">
        <div className="px-6 lg:px-8 xl:px-12 py-4 grid grid-cols-[auto_1fr] gap-4 items-start">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Star className="w-5 h-5 text-os-gray-300 shrink-0" />
          ...
          <div className="flex flex-wrap items-center gap-3 text-sm">
            ...
            <div className="flex-shrink-0">
              <div className="text-os-gray-300 text-xs mb-0.5">Top Offer</div>
              <div className="font-medium font-sans">
                3.807 <span className="text-os-gray-300">SOL</span>
              </div>
            </div>
            <div className="flex-shrink-0">
              <div className="text-os-gray-300 text-xs mb-0.5">24h Vol</div>
            ...
            <div className="flex-shrink-0">
              <div className="text-os-gray-300 text-xs mb-0.5">24h Sales</div>
              <div className="font-medium font-sans">37</div>
            </div>
            <div className="flex-shrink-0">
              <div className="text-os-gray-300 text-xs mb-0.5">All Vol</div>
              <div className="font-medium font-sans">
                557.763 <span className="text-os-gray-300">SOL</span>
              </div>
            </div>
            <div className="flex-shrink-0">
              <div className="text-os-gray-300 text-xs mb-0.5">Market Cap</div>
              <div className="font-medium font-sans">$867.1K</div>
            </div>
            <div className="flex-shrink-0">
              <div className="text-os-gray-300 text-xs mb-0.5">Listed / Supply</div>
              <div className="font-medium font-sans">
                38 / 1,000 <span className="text-os-gray-300">3.8%</span>
              </div>
            </div>
            <div className="flex-shrink-0">
              <div className="text-os-gray-300 text-xs mb-0.5">Owners</div>
