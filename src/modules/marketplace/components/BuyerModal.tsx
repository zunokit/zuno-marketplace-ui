          ...
          <Tabs defaultValue="buy" className="w-full">
                ...
                <>
                  <div className="rounded-[8px] bg-muted p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between font-medium font-sans text-base pt-2 border-t">
                        <span>Total:</span>
            ...
            <TabsContent value="offer" className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="0.05"
                />
                <p className="text-xs text-os-gray-300">Floor price: {nft.mintPrice} ETH</p>
              </div>
            ...
            <TabsContent value="details" className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between py-2 border-b">
                  <span className="text-os-gray-300">Owner</span>
                  <span className="font-mono text-xs">
