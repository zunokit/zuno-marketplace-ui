        ...
        {contractUrl && (
          <div className="flex flex-wrap gap-2 empty:hidden">
            <a
              ...
              className="w-fit py-2 px-3 flex items-center gap-2 transition-colors rounded bg-[#2a2a2a] hover:bg-[#333] border border-white/[0.08] text-sm text-foreground"
            >
              <span>Contract</span>
        ...
        <div className="flex flex-wrap gap-2 empty:hidden">
          {websiteUrl && (
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="w-fit py-2 px-2 flex items-center justify-center transition-colors rounded bg-[#2a2a2a] hover:bg-[#333] border border-white/[0.08] text-sm text-foreground"
            >
              <Globe size={18} />
            </a>
          )}
