...
import BannerItem from "@/modules/product-discovery/banner/components/banner-item";
import BannerPagination from "@/modules/product-discovery/banner/components/banner-pagination";
