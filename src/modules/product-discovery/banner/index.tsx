...
export function HomeBanner() {
  ...
  if (slides.length === 0) {
    return (
      <div className="w-full h-[200px] sm:h-[240px] md:h-[280px] lg:h-[320px] xl:h-[360px] rounded-[8px] md:rounded-[12px] overflow-hidden mb-3 md:mb-5 bg-secondary dark:bg-card border border-border-subtle animate-pulse" aria-busy="true" aria-label="Banner loading" />
    );
  }
