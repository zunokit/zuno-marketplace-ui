  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn(
        ...
        "hover:bg-frosted-1 transition-colors duration-200",
        className
      )}
      {...props}
    />
    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <div className="relative w-5 h-5 flex items-center justify-center">
          ...
          <ChevronDownIcon
            className="absolute size-4 shrink-0 text-muted-foreground transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-data-[state=open]:rotate-180 group-data-[state=open]:text-primary group-hover:text-foreground"
          />
        </div>
      </AccordionPrimitive.Trigger>
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        >
          <PlusIcon className="absolute size-3 text-muted-foreground transition-all duration-300 group-data-[state=open]:opacity-0 group-data-[state=open]:rotate-90 group-hover:text-foreground" />
...
function GlassAccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn(
        "mb-2 rounded-lg border border-border-subtle overflow-hidden",
        // Frosted glass background
        "bg-frosted-1 backdrop-blur-md",
        // Glow on hover
        "hover:border-border-medium hover:shadow-[0_0_20px_rgba(var(--primary-rgb),0.05)]",
        // Transition
