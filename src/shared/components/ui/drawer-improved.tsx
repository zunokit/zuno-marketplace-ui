...
function Drawer({ ...props }: React.ComponentProps<typeof DrawerPrimitive.Root>) {
  return <DrawerPrimitive.Root data-slot="drawer-improved" {...props} />;
}

function DrawerTrigger({ ...props }: React.ComponentProps<typeof DrawerPrimitive.Trigger>) {
  return <DrawerPrimitive.Trigger data-slot="drawer-improved-trigger" {...props} />;
}

function DrawerPortal({ ...props }: React.ComponentProps<typeof DrawerPrimitive.Portal>) {
  return <DrawerPrimitive.Portal data-slot="drawer-improved-portal" {...props} />;
}

function DrawerClose({ ...props }: React.ComponentProps<typeof DrawerPrimitive.Close>) {
  return <DrawerPrimitive.Close data-slot="drawer-improved-close" {...props} />;
}
...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      data-slot="drawer-improved-overlay"
      className={cn(
        "fixed inset-0 z-50",
...
function DrawerContent({
  ...
  return (
    <DrawerPortal data-slot="drawer-improved-portal">
      <DrawerOverlay />
      <DrawerPrimitive.Content
        data-slot="drawer-improved-content"
        className={cn(
          // Base styles
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="drawer-improved-header"
      className={cn(
...
function DrawerFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="drawer-improved-footer"
      className={cn(
...
function DrawerTitle({ className, ...props }: React.ComponentProps<typeof DrawerPrimitive.Title>) {
  return (
    <DrawerPrimitive.Title
      data-slot="drawer-improved-title"
      className={cn(
...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      data-slot="drawer-improved-description"
