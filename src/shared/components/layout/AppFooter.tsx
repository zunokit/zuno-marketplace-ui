...
export function AppFooter({ itemCount, openCart }: AppFooterProps) {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 bg-[#1a1a1a] border-t border-[#2a2a2a] px-3 md:px-6 py-2 md:py-3 z-50"
      role="navigation"
    >
      <div className="flex items-center justify-between text-xs md:text-sm overflow-x-auto">
        {/* Left Section */}
        <div className="flex items-center gap-2 md:gap-6">
          <button className="flex items-center gap-1 md:gap-2 text-white hover:text-gray-300 transition-colors">
            <span className="w-2 h-2 bg-green-500 rounded-full"></span>
            <span className="font-medium hidden sm:inline">Live</span>
          </button>
          <button className="hidden md:flex items-center gap-2 text-gray-400 hover:text-gray-300 transition-colors">
            <Zap className="w-4 h-4" />
            <span>Aggregating</span>
          </button>
          <button className="hidden lg:flex items-center gap-2 text-gray-400 hover:text-gray-300 transition-colors">
            <Radio className="w-4 h-4" />
            <span>Networks</span>
          </button>
          <div className="w-px h-4 bg-[#3a3a3a] hidden md:block"></div>
        </div>
        ...
        <div className="flex items-center gap-2 md:gap-6">
            ...
            >
              ...
              <div className="hidden md:flex items-center gap-1">
                ...
                <div className="w-6 h-6 rounded-full border border-gray-600 flex items-center justify-center">
                  <div className={`w-3 h-3 rounded-full ${currentTheme === "dark" ? "bg-white" : "bg-gray-600"}`}></div>
                </div>
              </div>
            </button>
          )}
          ...
          <button className="hidden md:block text-gray-400 hover:text-gray-300 transition-colors">Pro</button>
          <button className="hidden lg:block text-gray-400 hover:text-gray-300 transition-colors">Crypto</button>
          <button className="hidden lg:block text-gray-400 hover:text-gray-300 transition-colors">USD</button>
          <button className="hidden md:block text-gray-400 hover:text-gray-300 transition-colors">
