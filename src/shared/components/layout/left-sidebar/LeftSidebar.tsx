...
const DiscoverIcon = () => (
  <svg className="fill-current size-5 shrink-0" viewBox="0 -960 960 960" xmlns="http://www.w3.org/2000/svg">
...
const ChevronIcon = ({ className }: { className?: string }) => (
  <svg className={cn("fill-current size-5 shrink-0 transition-transform duration-150", className)} viewBox="0 -960 960 960" xmlns="http://www.w3.org/2000/svg">
    ...
    <>
      ...
      <aside className="group fixed inset-y-0 left-0 z-50 h-full hidden lg:block">
        ...
        >
          ...
          <Link
            href="/"
            className="flex w-full items-center gap-2 rounded-md h-9 p-[3px] mb-1"
          >
            <Image
          ...
          <NavItem href="/collections" icon={<CollectionsIcon />} label="Collections" isActive={isActive("/collections")} />
          <NavItem href="/tokens" icon={<TokensIcon />} label="Tokens" isActive={isActive("/tokens")} />
          ...
          <NavItem href="/activity" icon={<ActivityIcon />} label="Activity" isActive={isActive("/activity")} />
          <NavItem href="/rewards" icon={<RewardsIcon />} label="Rewards" isActive={isActive("/rewards")} />
          <NavItem href="/studio" icon={<StudioIcon />} label="Studio" isActive={isActive("/studio")} />
