...
const debugRoutes: DebugRoute[] = [
  ...
  },
  {
    href: "/debug/dialog",
    title: "Dialog & Alert",
    description: "Modal dialogs, confirmation alerts, and popup interactions",
    icon: MessageSquare,
    status: "ready",
    badge: "New",
  },
  {
    href: "/debug/card",
    title: "Card",
    description: "Card variants, NFT card patterns, and content layouts",
    icon: CreditCard,
    status: "ready",
    badge: "New",
  },
  ...
  },
  {
    href: "/debug/overlay",
    title: "Overlay",
    description: "Dropdown menus, popovers, and hover cards",
    icon: Layers,
    status: "ready",
    badge: "New",
  },
